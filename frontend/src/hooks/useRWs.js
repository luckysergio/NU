...
export const useRWs = (filters = {}, options = {}) => {
  ...
  const createMutation = useMutation({
    ...
    onMutate: async (data) => {
      await queryClient.cancelQueries({ queryKey: [RW_QUERY_KEY] });
      ...
      queryClient.setQueryData([RW_QUERY_KEY, filters], (old) => {
