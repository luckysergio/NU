...
import OrganizationTypeModal from "./OrganizationTypeModal";
...
const OrganizationTypes = () => {
    ...
    warning(
      ...
      async () => {
        ...
        try {
          ...
          success("Berhasil", "Tipe organisasi berhasil dihapus");
          ...
          error(
            ...
            err?.response?.data?.message ||
              err.message ||
              "Gagal menghapus tipe organisasi",
          );
        } finally {
  ...
  const getLevelName = (levelId) => {
    const level = LEVEL_OPTIONS.find((l) => l.id === levelId);
                    ...
                    {typeList.length === 0 ? (
                      ...
                      typeList.map((type, index) => (
                        ...
                        >
                          ...
                          <td className="text-center px-6 py-4">
                            <span
                              className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getLevelBadgeColor(
                            ...
                            <td className="text-center px-6 py-4">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                <button
                                  ...
                                  title="Hapus"
                                  disabled={
                                    actionLoading[type.id] || isDeleting
                                  }
                                >
