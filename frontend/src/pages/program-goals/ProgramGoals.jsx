...
import ProgramGoalModal from "./ProgramGoalModal";
import ProgramGoalDetail from "./ProgramGoalDetail";
...
const ProgramGoals = () => {
  ...
  // ✅ Gunakan hook useProgramGoal dengan optimistic update
  const {
    data: response,
    isLoading,
    isFetching,
  ...
  const handleDelete = (goal) => {
    ...
    warning(
      ...
      async () => {
        setActionLoading((prev) => ({ ...prev, [goal.id]: true }));
        try {
          await deleteGoal(goal.id);
          success("Berhasil", "Tujuan program berhasil dihapus");

          if (goalList.length === 1 && page > 1) {
            setPage(page - 1);
          }
        } catch (err) {
          ...
          error(
            ...
            err?.response?.data?.message ||
              err.message ||
              "Gagal menghapus tujuan program",
          );
        } finally {
          setActionLoading((prev) => ({ ...prev, [goal.id]: false }));
        }
      },
    );
  };
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Cari berdasarkan nama tujuan program..."
                            ...
                            <td className="text-center px-6 py-4">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                <button
                                  ...
                                  title="Hapus"
                                  disabled={
                                    actionLoading[goal.id] || isDeleting
                                  }
                                >
