...
const ProgramGoalDetail = ({ isOpen, onClose, goal, onEdit, canEdit }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200">
          ...
          <div className="relative flex justify-between items-center">
            <div>
              ...
              <p className="text-emerald-100 text-sm mt-0.5">
                Informasi lengkap tujuan program
              </p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-140px)] p-6">
          ...
          <div className="text-center mb-6">
            ...
            <h3 className="text-xl font-bold text-gray-800">{goal.nama}</h3>
          </div>
...
export default ProgramGoalDetail;