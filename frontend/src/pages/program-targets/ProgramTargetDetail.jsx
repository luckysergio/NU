...
const ProgramTargetDetail = ({ isOpen, onClose, target, onEdit, canEdit }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200">
          ...
          <div className="relative flex justify-between items-center">
            <div>
              <h2 className="text-xl font-bold text-white">
                Detail Sasaran Program
              </h2>
              <p className="text-emerald-100 text-sm mt-0.5">
                Informasi lengkap sasaran program
              </p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-140px)] p-6">
          ...
          <div className="text-center mb-6">
            ...
            <h3 className="text-xl font-bold text-gray-800">{target.nama}</h3>
          </div>
...
export default ProgramTargetDetail;