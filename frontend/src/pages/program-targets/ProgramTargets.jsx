...
import ProgramTargetModal from "./ProgramTargetModal";
import ProgramTargetDetail from "./ProgramTargetDetail";
...
const ProgramTargets = () => {
  ...
  // ✅ Gunakan hook useProgramTarget dengan optimistic update
  const {
    data: response,
    isLoading,
    isFetching,
    ...
    warning(
      ...
      async () => {
        ...
        try {
          ...
          success("Berhasil", "Sasaran program berhasil dihapus");

          if (targetList.length === 1 && page > 1) {
            setPage(page - 1);
          }
        } catch (err) {
          ...
          error(
            ...
            err?.response?.data?.message ||
              err.message ||
              "Gagal menghapus sasaran program",
          );
        } finally {
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Cari berdasarkan nama sasaran program..."
                        ...
                        >
                          <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-gray-500">
                              Tidak ada data sasaran program
                            </p>
                            {hasActiveFilters && (
                              <button
                                onClick={handleReset}
                            ...
                            <td className="text-center px-6 py-4">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                <button
                                  ...
                                  title="Hapus"
                                  disabled={
                                    actionLoading[target.id] || isDeleting
                                  }
                                >
