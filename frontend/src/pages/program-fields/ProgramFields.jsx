...
import ProgramFieldModal from "./ProgramFieldModal";
import ProgramFieldDetail from "./ProgramFieldDetail";
...
const ProgramFields = () => {
  ...
  // ✅ Gunakan hook useProgramField dengan optimistic update
  const {
    data: response,
    isLoading,
    isFetching,
  ...
  const handleDelete = (field) => {
    ...
    warning(
      ...
      async () => {
        setActionLoading((prev) => ({ ...prev, [field.id]: true }));
        try {
          await deleteField(field.id);
          success("Berhasil", "Bidang program berhasil dihapus");

          if (fieldList.length === 1 && page > 1) {
            setPage(page - 1);
          }
        } catch (err) {
          ...
          error(
            ...
            err?.response?.data?.message ||
              err.message ||
              "Gagal menghapus bidang program",
          );
        } finally {
          setActionLoading((prev) => ({ ...prev, [field.id]: false }));
        }
      },
    );
  };
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Cari berdasarkan nama bidang program..."
                            ...
                            <td className="text-center px-6 py-4">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                <button
                                  ...
                                  title="Hapus"
                                  disabled={
                                    actionLoading[field.id] || isDeleting
                                  }
                                >
